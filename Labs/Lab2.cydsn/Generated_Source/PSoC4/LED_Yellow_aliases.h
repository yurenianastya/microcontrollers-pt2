...
#define LED_Yellow_0_PS		(LED_Yellow__0__PS)
#define LED_Yellow_0_PC		(LED_Yellow__0__PC)
#define LED_Yellow_0_DR		(LED_Yellow__0__DR)
#define LED_Yellow_0_SHIFT	(LED_Yellow__0__SHIFT)
#define LED_Yellow_0_INTR	((uint16)((uint16)0x0003u << (LED_Yellow__0__SHIFT*2u)))
